    ...
    while True:
        try:
            ...
            if cmd == "step":
                ...
                remote.send(env.observation_space.seed(data))
            elif cmd == "reset":
...
class SubprocVecEnv(VecEnv):
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        self.waiting = False
        obs, rews, terms, truncs, infos = zip(*results) # terminated, truncated
        return _flatten_obs(obs, self.observation_space), np.stack(rews), np.stack(terms), np.stack(truncs), infos
