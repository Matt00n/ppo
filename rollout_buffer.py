...
from .utils.utils import get_action_dim, get_obs_shape, get_device
...
class BaseBuffer(ABC):
    ...
    def _normalize_obs(
        ...
        env: Optional[gym.Env] = None, # TODO formerly VecNormalize
    ...
    @staticmethod
    def _normalize_reward(reward: np.ndarray, env: Optional[gym.Env] = None) -> np.ndarray: # TODO formerly VecNormalize
        if env is not None:
